...
modeloSVM_T$results[modeloSVM_T$results[,1]==modeloSVM_T$bestTune[1,1],] %>% 
  kableExtra::kable(booktabs=TRUE , caption = "Métricas del mejor modelo SVM. Algoritmo 1.1") %>% 
...
modeloSVM_T$resample %>%  
  kableExtra::kable(booktabs=TRUE , caption = "Métricas en el remuestreo. Modelo SVM. Algoritmo 1.1") %>% 
...
modeloKNN_T$results[modeloKNN_T$results[,1]==modeloKNN_T$bestTune[1,1],] %>% 
  kableExtra::kable(booktabs=TRUE , caption = "Métricas del mejor modelo KNN. Algoritmo 2.1") %>% 
    kableExtra::kable_styling(latex_options = c("HOLD_position","striped") )
```
...
modeloKNN_T$resample %>% 
    kableExtra::kable(booktabs=TRUE , caption = "Métricas en el remuestreo. Modelo KNN. Algoritmo 2.1",longtable = T) %>% 
    kableExtra::kable_styling(latex_options = c("HOLD_position","striped") )
```
...
modeloXGB_T$results[modeloXGB_T$results[,7]==modeloXGB_T$bestTune[1,1] & modeloXGB_T$results[,2]==modeloXGB_T$bestTune[1,2] & modeloXGB_T$results[,1]==modeloXGB_T$bestTune[1,3] & modeloXGB_T$results[,4]==modeloXGB_T$bestTune[1,5] & modeloXGB_T$results[,4]==modeloXGB_T$bestTune[1,5] & modeloXGB_T$results[,5]==modeloXGB_T$bestTune[1,6] & modeloXGB_T$results[,6]==modeloXGB_T$bestTune[1,7] ,] %>% 
  kableExtra::kable(booktabs=TRUE , caption = "Métricas del mejor modelo XGBoost. Algoritmo 3.1") %>% 
...
modeloXGB_T$resample  %>% 
   kableExtra::kable(booktabs=TRUE , caption = "Métricas en el remuestreo. Modelo XGBoost. Algoritmo 3.1",longtable = T) %>% 
...
cbind.data.frame(DatosTesteo_Total$FECHA,PrediccionTotal,DatosTesteo_Total$VENTAS,abs(PrediccionTotal-DatosTesteo_Total$VENTAS)) %>% 
  kable(booktabs=TRUE,caption = "Resultados de predicción. Volumen total de ventas. Algoritmo Máquina de vector soporte", longtable=TRUE,col.names = c("Fecha","Predicción","Valor real","Error absoluto en la predicción")) %>%
...
```{r}
PredTotal = cbind.data.frame(DatosTesteo_Total$FECHA,PrediccionTotal,DatosTesteo_Total$VENTAS,abs(PrediccionTotal-DatosTesteo_Total$VENTAS)) 
colnames(PredTotal)<-c("Fecha","Predicción","ValorReal","ErrorAbs")
save(PredTotal,file = "Shiny/datos/PrediccionesTotalVentas.RData")
```
...
modeloSVM_C$results[modeloSVM_C$results[,1]==modeloSVM_C$bestTune[1,1],] %>% 
  kableExtra::kable(booktabs=TRUE , caption = "Métricas del mejor modelo SVM. Algoritmo 1.2") %>% 
    kableExtra::kable_styling(latex_options = "HOLD_position")
```
...
modeloSVM_C$resample %>% 
  kableExtra::kable(booktabs=TRUE , caption = "Métricas en el remuestreo. Modelo SVM. Algoritmo 1.2",longtable = T) %>% 
    kableExtra::kable_styling(latex_options = c("HOLD_position","striped","repeat_header") )
```
...
modeloKNN_C$results[modeloKNN_C$results[,1]==modeloKNN_C$bestTune[1,1],] %>% 
  kableExtra::kable(booktabs=TRUE , caption = "Métricas del mejor modelo KNN. Algoritmo 2.2") %>% 
    kableExtra::kable_styling(latex_options = "HOLD_position")
```
...
modeloKNN_C$resample%>% 
   kableExtra::kable(booktabs=TRUE , caption = "Métricas en el remuestreo. Modelo KNN. Algoritmo 2.2",longtable = T) %>% 
    kableExtra::kable_styling(latex_options = c("HOLD_position","striped","repeat_header") )
```
...
modeloXGB_C$results[modeloXGB_C$results[,7]==modeloXGB_C$bestTune[1,1] & modeloXGB_C$results[,2]==modeloXGB_C$bestTune[1,2] & modeloXGB_C$results[,1]==modeloXGB_C$bestTune[1,3] & modeloXGB_C$results[,4]==modeloXGB_C$bestTune[1,5] & modeloXGB_C$results[,4]==modeloXGB_C$bestTune[1,5] & modeloXGB_C$results[,5]==modeloXGB_C$bestTune[1,6] & modeloXGB_C$results[,6]==modeloXGB_C$bestTune[1,7] ,] %>% 
  kableExtra::kable(booktabs=TRUE , caption = "Métricas del mejor modelo XGBoost. Algoritmo 3.2") %>% 
    kableExtra::kable_styling(latex_options = c("HOLD_position","scale_down","striped"))
```
...
modeloXGB_C$resample%>% 
  kableExtra::kable(booktabs=TRUE , caption = "Métricas en el remuestreo. Modelo XGBoost. Algoritmo 3.2",longtable = T) %>% 
    kableExtra::kable_styling(latex_options = c("HOLD_position","striped","repeat_header") )
```
...
cbind.data.frame(DatosTesteo_Calcio$FECHA,PrediccionCalcio,DatosTesteo_Calcio$VENTAS,abs(PrediccionCalcio-DatosTesteo_Calcio$VENTAS)) %>% 
  kable(booktabs=TRUE,longtable=T,caption = "Resultados de predicción. Volumen total de ventas. Algoritmo XGBoost", col.names = c("Fecha","Predicción","Valor real","Error absoluto en la predicción")) %>%
  kable_styling(latex_options = c("striped","HOLD_position","repeat_header" ) )
```
...
```{r}
PredCalcio = cbind.data.frame(DatosTesteo_Calcio$FECHA,PrediccionCalcio,DatosTesteo_Calcio$VENTAS,abs(PrediccionCalcio-DatosTesteo_Calcio$VENTAS))
colnames(PredCalcio)<-c("Fecha","Predicción","ValorReal","ErrorAbs")
save(PredCalcio,file = "Shiny/datos/PrediccionesCalcioVentas.RData")
```
...
modeloSVM_SC$results[modeloSVM_SC$results[,1]==modeloSVM_SC$bestTune[1,1],] %>% 
  kableExtra::kable(booktabs=TRUE , caption = "Métricas del mejor modelo SVM. Algoritmo 3.1") %>% 
    kableExtra::kable_styling(latex_options = "HOLD_position")
```
...
modeloSVM_SC$resample%>% 
  kableExtra::kable(booktabs=TRUE , caption = "Métricas en el remuestreo. Modelo SVM. Algoritmo 3.1",longtable = T) %>% 
    kableExtra::kable_styling(latex_options = c("HOLD_position","striped","repeat_header") )
```
...
modeloKNN_SC$results[modeloKNN_SC$results[,1]==modeloKNN_SC$bestTune[1,1],] %>% 
  kableExtra::kable(booktabs=TRUE , caption = "Métricas del mejor modelo KNN. Algoritmo 3.2") %>% 
    kableExtra::kable_styling(latex_options = "HOLD_position")
```
...
modeloKNN_SC$resample%>% 
   kableExtra::kable(booktabs=TRUE , caption = "Métricas en el remuestreo. Modelo KNN. Algoritmo 3.2",longtable = T) %>% 
    kableExtra::kable_styling(latex_options = c("HOLD_position","striped","repeat_header") )
```
...
modeloXGB_SC$results[modeloXGB_SC$results[,7]==modeloXGB_SC$bestTune[1,1] & modeloXGB_SC$results[,2]==modeloXGB_SC$bestTune[1,2] & modeloXGB_SC$results[,1]==modeloXGB_SC$bestTune[1,3] & modeloXGB_SC$results[,4]==modeloXGB_SC$bestTune[1,5] & modeloXGB_SC$results[,4]==modeloXGB_SC$bestTune[1,5] & modeloXGB_SC$results[,5]==modeloXGB_SC$bestTune[1,6] & modeloXGB_SC$results[,6]==modeloXGB_SC$bestTune[1,7] ,] %>% 
  kableExtra::kable(booktabs=TRUE , caption = "Métricas del mejor modelo XGBoost. Algoritmo 3.3") %>% 
    kableExtra::kable_styling(latex_options = c("HOLD_position","scale_down","striped"))
```
...
modeloXGB_SC$resample%>% 
 kableExtra::kable(booktabs=TRUE , caption = "Métricas en el remuestreo. Modelo XGBoost. Algoritmo 3.3",longtable = T) %>% 
    kableExtra::kable_styling(latex_options = c("HOLD_position","striped","repeat_header") )
```
...
Observando la tabla, el modelo seleccionado para predecir el volumen de ventas para el producto con sin calcio en los datos de testeo es el modelo de máquina de vector soporte, ya que el valor del coeficiente de correlación es bastante mejor que el resto, a pesar de que el valor de RMSE ofrecido por el modelo XGBoost sea menor.
...
```{r}
PredSinCalcio = cbind.data.frame(DatosTesteo_SinCalcio$FECHA,PrediccionSinCalcio,DatosTesteo_SinCalcio$VENTAS,abs(PrediccionSinCalcio-DatosTesteo_SinCalcio$VENTAS))
colnames(PredSinCalcio)<-c("Fecha","Predicción","ValorReal","ErrorAbs")
save(PredSinCalcio,file = "Shiny/datos/PrediccionesSinCalcioVentas.RData")
```
...
```{r}
cbind(Predicción= c("Suma de productos","Producto con calcio","Producto sin calcio"),
      Modelo=c("SVM","XGBoost","SVM"),
      rbind(
...
round(postResample(PrediccionSinCalcio,DatosTesteo_SinCalcio$VENTAS ) ,3) )) %>% 
  kable(booktabs=TRUE, caption = "Resultados de la predicción en los datos de testeo. Comparación de métricas.") %>% 
...
```{r}
comparacionPreds = cbind.data.frame(Pred,Tipo,Fecha)
save(comparacionPreds,file = "Shiny/datos/CompPreds.RData")
```
