...
# escribe SOLO el fichero de bibliografía con el listado de paquetes que yo diga NO TOCAR ESE FICHERO 
...
<!-- \nocite{*} -->
\nocite{Luque2017,Luque2019,RStudio,R-base,R-knitr,R-rmarkdown,R-dplyr,R-ggplot2,MestaTFG,DefSectorRetail,ST_Apuntes
# , ST_Art,ST_LibroUbiqum
}
